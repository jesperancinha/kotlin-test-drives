package org.jesperancinha.kotlin.crums3.arrowbasics
...
class ArrowRecord {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            ...
            logger.info(
                "This album doesn't exist but it goes through ${
                    createAlbumOfThe90s(
                        "Cesaria Evora",
                        "La Diva Aux Pieds Nus",
                        1997
                    )
                }. The true year is 1989"
            )
        }
...
private fun createAlbumOfThe90s(band: String?, title: String?, year: Long) = nullable {
    Record(
        band = band.bind(),
